...
def build_werk_from_starting_directory(starting_dir):
    build_werk_table()
    all_results = process_all_werk_results_dirs_to_df(starting_dir)
    insert_statements = [generate_insert_query(dict_werk_column_name_to_value, 'werk') for dict_werk_column_name_to_value in all_results]
